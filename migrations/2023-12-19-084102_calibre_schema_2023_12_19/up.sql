-- Generated by running `sqlite3 <path-to-db> .schema` on a Calibre-created database
-- Created on 2023-12-19 using Calibre 6.
...
-- Disabling; including these produces an error that the table already exists
...
CREATE TRIGGER fkc_update_custom_column_1
                        ...
                        BEGIN
                            ...
                            END;
                        END;
-- DISABLING: We will not use these, and creating them causes issues with Diesel.;
